...
<?php require_once("C:\\wamp\\www\\widget_corp\\includes\\validation_functions.php"); ?>
<?php confirm_logged_in(); ?>

<?php find_selected_page(); ?>

<?php if (!$current_subject) {
		// subject_id was missing or
...
<div id="main">
  ...
  <div id="page">
  		<?php // $message in just a variable, doesnt use the SESSION
  			if (!empty($message)) {
