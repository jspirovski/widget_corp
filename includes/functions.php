<?php
	...
	function find_all_subjects($public=true) {
		...
		// 2. Perform database query : sql statement
		$query = "SELECT * ";
		$query .= "FROM subjects ";
		if ($public) {
	...
	function navigation($subject_array, $page_array) {
		...
		// 3. Use returned data (if any) from previous query
	...
	function password_encrypt($password) {
		...
		$salt_length = 22;			// Blowfish salts should be 22-characters of more
	...
	function password_check($password, $existing_hash) {
		// extsting hash contains format and salt at start
